...
type iso3166Code struct {
    country, iso3166 string
}

var iso3166Codes = []iso3166Code {
    {"AFGHANISTAN", "AF"},
    {"ALBANIA", "AL"},
    {"ALGERIA", "DZ"},
    {"AMERICAN SAMOA", "AS"},
...
func Iso3166Countries() []string {
    countries := make([]string, len(iso3166Codes), len(iso3166Codes))
    for i, x := range(iso3166Codes) {
        countries[i] = x.country
    }
    return countries
}
